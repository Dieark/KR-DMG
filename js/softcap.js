...
function tableloading(){
	...
	$("td:eq(9)").text(dodge.X2);
	$("td:eq(10)").text(dodge.X1);
	$("td:eq(12)").text(critresist.X2);
	$("td:eq(13)").text(critresist.X1);
	$("td:eq(15)").text(ccresist.X2);
	$("td:eq(16)").text(ccresist.X1);
...
function calc(){
	...
	$("td:eq(11)").text(real(dodge)).append("%");
	$("td:eq(14)").text(real(critresist)).append("%");
	$("td:eq(17)").text(real(ccresist)).append("%");
